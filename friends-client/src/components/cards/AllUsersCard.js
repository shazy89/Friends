    ...
    if (potentialFriend.name || potentialFriend.about) {
      return (
        <div>
          ...
          {potentialFriend.public_email ? (
            <p>contact: {potentialFriend.public_email}</p>
          ) : null}
  ...
  return (
    <div id={potentialFriend.id}>
      <Col m={3} s={12} l={3} id={potentialFriend.id}>
        ...
        >
          <Button
            className="right e8eaf6 indigo lighten-5 black-text text-darken-2"
